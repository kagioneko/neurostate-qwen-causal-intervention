...
OUTPUT = ROOT / "neurostate_qwen_causal_intervention_v0_2_colab.ipynb"
...
cells = [
    ...
    code("from pathlib import Path\nWORK=Path('/content/neurostate_qwen_causal_intervention_v0_2')\nWORK.mkdir(parents=True,exist_ok=True)\n"),
]
...
cells.extend([
    markdown("## Layer Scan"),
    code(
        "!cd /content/neurostate_qwen_causal_intervention_v0_2 && "
    ...
    code(
        "# !cd /content/neurostate_qwen_causal_intervention_v0_2 && python run_intervention.py --direction-json qwen_middle_prompt_direction.json --mode full --layers 15 --output-dir outputs_full\n"
        "# !cd /content/neurostate_qwen_causal_intervention_v0_2 && python analyze_intervention.py --runs outputs_full/intervention_full.jsonl --output-dir analysis_full\n"
    ),
    code(
        "import shutil\nfrom google.colab import files\n"
        "archive=shutil.make_archive('/content/neurostate_qwen_causal_intervention_v0_2_results','zip',WORK)\n"
